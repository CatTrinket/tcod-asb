...
<p>
    <strong>Win</strong>: ${len(win_battles)}
    <strong>Loss</strong>: ${len(loss_battles)}
    <strong>Draw</strong>: ${len(draw_battles)}
    <strong>Total</strong>: ${len(win_battles) + len(loss_battles) + len(draw_battles)}
</p>
